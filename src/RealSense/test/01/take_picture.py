...
cfg.enable_stream(rs.stream.color, 1280, 720)
...
depth_image2 = cv2.resize(depth_image2, (1280, 720))
color_image2 = cv2.resize(color_image2, (1280, 720))
...
p.intrinsic_matrix=[[635.682, 0.0, 643.285], [ 0.0, 635.682, 355.427], [ 0.0, 0.0, 1.0]] #High resolution
